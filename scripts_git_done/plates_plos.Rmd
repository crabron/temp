...
uni.steppo.soil <- function(some_number){
...
uni.steppo.betadisp.soil <- function(some_number){
  ps.soil <- tip_glom(ps.soil, some_number) 
...
metadata <- as(sample_data(ps.soil.rand), "data.frame")
ad <- adonis2(dist ~ Soil, data = metadata)
ad
